...
{
public:
    QGridLayout *TopGirdLayout;
    QVBoxLayout *verticalLayout_6;
    QHBoxLayout *horizontalLayout_8;
    QSpacerItem *horizontalSpacer_3;
    QVBoxLayout *VL_component;
    ...
    void setupUi(QDialog *Login)
    {
        ...
        TopGirdLayout = new QGridLayout(Login);
        TopGirdLayout->setObjectName(QStringLiteral("TopGirdLayout"));
        ...
        VL_component = new QVBoxLayout();
        VL_component->setObjectName(QStringLiteral("VL_component"));
        ...
        VL_component->addLayout(verticalLayout_2);
...
"background-color: rgb(255, 85, 127);"));
        ...
        B_Register = new QPushButton(Login);
        B_Register->setObjectName(QStringLiteral("B_Register"));
        QSizePolicy sizePolicy3(QSizePolicy::Preferred, QSizePolicy::Fixed);
        sizePolicy3.setHorizontalStretch(0);
        sizePolicy3.setVerticalStretch(0);
        sizePolicy3.setHeightForWidth(B_Register->sizePolicy().hasHeightForWidth());
        B_Register->setSizePolicy(sizePolicy3);
        B_Register->setFont(font3);
        B_Register->setStyleSheet(QStringLiteral("background-color: rgb(200, 80, 59);"));

        horizontalLayout_4->addWidget(B_Register);
        ...
        VL_component->addLayout(verticalLayout_4);


        horizontalLayout_8->addLayout(VL_component);
        ...
        TopGirdLayout->addLayout(verticalLayout_6, 0, 0, 1, 1);
    ...
    void retranslateUi(QDialog *Login)
    {
        ...
        B_Register->setText(QApplication::translate("Login", "Register", Q_NULLPTR));
    } // retranslateUi
